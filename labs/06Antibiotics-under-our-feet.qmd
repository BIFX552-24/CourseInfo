...
<!-- 
GitHub Classroom:
  - Starter code: https://github.com/BIFX552-24/Antibiotics-under-our-feet
...
The dataset we will be using comes from a study called Antibiotics Under Our Feet[^1]. It has been [shared on figshare](https://figshare.com/articles/dataset/Antibiotics_under_our_feet_investigating_antimicrobial_resistance_Scotland_/23770230). Starter code can be accessed [here](https://classroom.github.com/a/mLqwDztl)
